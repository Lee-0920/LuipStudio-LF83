...
namespace System
{
bool Uncompress::IsDir(String path)
{
...
bool Uncompress::UnZipToDirectory(String zipPathName, String destDirectory, QStringList &listPic, String password)
{
    bool ret = true;
...
String Uncompress::ParserUnzipVersion(String zipPathName)
{
    String version;
