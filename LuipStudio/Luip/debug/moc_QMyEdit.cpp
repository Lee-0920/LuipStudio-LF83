...
struct qt_meta_stringdata_QMyEdit_t {
    QByteArrayData data[3];
    char stringdata0[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QMyEdit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QMyEdit_t qt_meta_stringdata_QMyEdit = {
    {
QT_MOC_LITERAL(0, 0, 7), // "QMyEdit"
QT_MOC_LITERAL(1, 8, 15), // "LineEditClicked"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "QMyEdit\0LineEditClicked\0"
};
...
void QMyEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QMyEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMyEdit::LineEditClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QMyEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_QMyEdit.data,
      qt_meta_data_QMyEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QMyEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QMyEdit.stringdata0))
