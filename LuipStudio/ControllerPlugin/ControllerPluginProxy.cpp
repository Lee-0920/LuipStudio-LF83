...
OOLUA_EXPORT_FUNCTIONS(Version, GetMajor, SetMajor, GetMinor,
                       ...
                       SetBuild, Parse)
OOLUA_EXPORT_FUNCTIONS_CONST(Version, ToString)
...
OOLUA_PROXY_END*/
OOLUA_EXPORT_FUNCTIONS(DeviceInterface, GetAddress, SetAddress, GetTimeout, SetTimeout,
...
ControllerPluginProxy::ControllerPluginProxy()
{

}

void ControllerPluginProxy::Proxy()
{
    ...
    lua->register_class<ISignalNotifiable>();
}
